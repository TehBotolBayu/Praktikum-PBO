...
public class Main {
    ...
    public static void tambah(String tipe) throws IOException, InterruptedException {
        try {
            ...
            if(tipe == "planet"){
                ...
                System.out.print("Temperatur: "); temperatur = Double.parseDouble(br.readLine());
                System.out.print("Warna: ");
            } if(tipe == "galaksi" || tipe == "objek"){
                System.out.print("Jenis: ");
            }
            String lanjut = br.readLine();
            System.out.print("Massa: "); double massa = Double.parseDouble(br.readLine());
            System.out.print("Diameter: "); double diameter = Double.parseDouble(br.readLine());
    ...
    public static void ubah(String tipe) throws IOException, InterruptedException{
        try {
            ...
            double diameter = 0;
            if(tipe == "planet"){
                System.out.print(planet.get(no-1).nama + "\r");  nama = br.readLine();
                System.out.println("Orbit: ");
                System.out.print(planet.get(no-1).orbit_bintang + "\r"); lanjut = br.readLine();
                System.out.println("Massa: "); 
                System.out.print(planet.get(no-1).massa + "\r"); massa = Double.parseDouble(br.readLine());
                System.out.println("Diameter: ");
                System.out.print(planet.get(no-1).diameter + "\r"); diameter = Double.parseDouble(br.readLine());
            } if (tipe == "bintang"){
                System.out.print(bintang.get(no-1).nama + "\r");   nama = br.readLine();
                System.out.println("Temperatur: ");
                System.out.print(bintang.get(no-1).temperatur + "\r"); temperatur = Double.parseDouble(br.readLine());
                System.out.println("Warna: ");
                System.out.print(bintang.get(no-1).warna + "\r"); lanjut = br.readLine();
                System.out.println("Massa: "); 
                System.out.print(bintang.get(no-1).massa + "\r"); massa = Double.parseDouble(br.readLine());
                System.out.println("Diameter: ");
                System.out.print(bintang.get(no-1).diameter + "\r"); diameter = Double.parseDouble(br.readLine());
            } if(tipe == "galaksi"){
                System.out.print(galaksi.get(no-1).nama + "\r");   nama = br.readLine();
                System.out.print("Jenis: ");
                System.out.print(galaksi.get(no-1).jenis + "\r"); lanjut = br.readLine();
                System.out.println("Massa: "); 
                System.out.print(galaksi.get(no-1).massa + "\r"); massa = Double.parseDouble(br.readLine());
                System.out.println("Diameter: ");
                System.out.print(galaksi.get(no-1).diameter + "\r"); diameter = Double.parseDouble(br.readLine());
            } if(tipe == "objek"){
                System.out.print(objek.get(no-1).nama + "\r");   nama = br.readLine();
                System.out.println("Jenis: ");
                System.out.print(objek.get(no-1).jenis + "\r");lanjut = br.readLine();
                System.out.println("Massa: "); 
                System.out.print(objek.get(no-1).massa + "\r"); massa = Double.parseDouble(br.readLine());
                System.out.println("Diameter: ");
                System.out.print(objek.get(no-1).diameter + "\r"); diameter = Double.parseDouble(br.readLine());
            }
